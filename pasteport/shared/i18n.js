(() => {
  ...
  const TRANSLATIONS = Object.freeze({
    "pt-BR": Object.freeze({
      ...
      "modal.description": "Escolha uma imagem recente da área de transferência ou selecione um arquivo.",
      ...
      "options.onlyImagesHint": "Abre somente em campos que declaram aceitar imagens.",
      "options.dragDrop": "Ativar drag-and-drop",
      "options.dragDropHint": "Permite arrastar imagens sobre a lista da área de transferência.",
    ...
    "en": Object.freeze({
      ...
      "modal.description": "Choose a recent clipboard image or select a file.",
      ...
      "options.onlyImagesHint": "Opens only on fields that declare they accept images.",
      "options.dragDrop": "Enable drag-and-drop",
      "options.dragDropHint": "Lets you drag images over the clipboard list.",
    ...
    "es": Object.freeze({
      ...
      "modal.description": "Elige una imagen reciente del portapapeles o selecciona un archivo.",
      ...
      "options.onlyImagesHint": "Se abre solo en campos que declaran aceptar imágenes.",
      "options.dragDrop": "Activar arrastrar y soltar",
      "options.dragDropHint": "Permite arrastrar imágenes sobre la lista del portapapeles.",
